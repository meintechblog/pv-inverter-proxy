...
- [ ] **CFG-03**: MQTT konfigurierbar — Venus OS IP, Port, Portal ID als Config-Felder statt hardcoded
...
- [ ] **SETUP-02**: MQTT Setup Guide — Hinweis-Card wenn MQTT nicht verbunden mit Anleitung (Venus OS Remote Console → Settings → Services → MQTT on LAN)
- [ ] **SETUP-03**: Dashboard MQTT-Gate — Lock Toggle, Override, Venus Settings ausgegraut mit Overlay-Hint bis MQTT connected
